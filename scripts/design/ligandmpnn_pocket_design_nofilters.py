...
os.chdir(f"{SCRIPT_PATH}/../../1Z9Yout/3.1_design_pocket_ligandMPNN/not_filtered")
...
for N in range(args.nstruct):
    ...
    while len(filt_scores) == 0:
        ...
        _pose = poses_iter[best_score_id].clone() # replaced n by best_score_id to keep the best sequence
